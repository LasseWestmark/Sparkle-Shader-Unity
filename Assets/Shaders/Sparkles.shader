Shader "Westmark/Sparkles"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _SparkleDepth, _NoiseScale, _AnimSpeed, _SpecPow, _GlitterPow, _ReflId, _RefrId, _ReflRoughness, _RefrRoughness;

			float4 ComputeGrabScreenPosInvert (float4 pos) {
